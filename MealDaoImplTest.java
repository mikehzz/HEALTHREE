...
public class MealDaoImplTest {
	...
	public void testGetMonthStats() throws SQLException {
	    ...
	    // 예상 결과 값
	    double expectedTotalCaloriesUser1 = 314; // (100 + 200) + (100 + 300) = 600
	    double expectedTotalCarbohydratesUser1 = 3.5; // (10 + 15) + (10 + 20) = 45
	    double expectedTotalProteinUser1 = 43.2; // (5 + 7) + (5 + 10) = 22
	    double expectedTotalFatUser1 = 14.2; // (2 + 3) + (2 + 5) = 10

	    // 테스트 실행
	    List<MonthStats> statsListUser1 = dao.getMonthStats("tester00", "B");
	    assertEquals(1, statsListUser1.size());

	    MonthStats statsUser1 = statsListUser1.get(0);
