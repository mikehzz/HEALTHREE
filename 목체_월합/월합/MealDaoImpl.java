...
// 월 합
    @Override
    public List<MonthStats> getMonthStats(String memberId, String mealType) throws SQLException {
        List<MonthStats> statsList = new ArrayList<>();
        ...
        statsList = this.jdbcTemplate.query(sb.toString(), args, new RowMapper<MonthStats>() {
            @Override
            public MonthStats mapRow(ResultSet rs, int rowNum) throws SQLException {
