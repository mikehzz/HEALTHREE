...
public interface MealDao {
	...
	// 월 일일 평균
    List<MonthAvg> getMonth(String memberId, String mealType) throws SQLException;
    // 일일 총합
	List<DayTotal> getDayStats(String memberId, String mealType);

	List<MonthAvg> getMonthAvg(String memberId, String mealType) throws SQLException;
